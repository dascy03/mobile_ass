  ...
  const New_Wallet = () => {
    ...
    return (
      <StyledView style={styles.container}>
        ...
        <StyledView>
        <StyledView className="bg-[#D9D9D9] h-[30]"></StyledView>
          <StyledView>
            <StyledView className="flex-row gap-4 p-3">
              ...
              <StyledView className="justify-center border-b-2 border-[#D9D9D9]">
                <TextInput placeholder="Tên ví"></TextInput>
              </StyledView>
            </StyledView>
          </StyledView>
          <StyledView>
            <StyledView className="flex-row gap-4 p-3">
              ...
              />
              <StyledView className="justify-center border-b-2 border-[#D9D9D9]">
                <TextInput placeholder="Số dư ban đầu"></TextInput>
              </StyledView>
            </StyledView>
          </StyledView>
          <StyledView>
            <StyledView className="flex-row gap-4 p-3">
              ...
              />
              <StyledView className="justify-center border-b-2 border-[#D9D9D9]">
                <TextInput placeholder="Biểu tượng"></TextInput>
              </StyledView>
            </StyledView>
          </StyledView>
        </StyledView>
